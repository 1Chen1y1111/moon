const utilityButtonClassName =
  'flex h-8 w-8 items-center justify-center rounded-full border border-white/6 bg-white/[0.03] text-[var(--alma-text-secondary)] transition-colors hover:bg-white/[0.06] hover:text-[var(--alma-text-primary)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--alma-accent)]'
  ...
  return (
    <header className="flex items-center justify-between border-b border-[color:var(--alma-sidebar-border)] px-4 py-3">
      ...
      <div className="flex items-center gap-1.5">
        <button type="button" aria-label="搜索" className={utilityButtonClassName}>
        ...
        <button type="button" aria-label="筛选" className={utilityButtonClassName}>
          <svg aria-hidden="true" viewBox="0 0 16 16" className="h-3.5 w-3.5 fill-none stroke-current">
            <path
        ...
        <button type="button" aria-label="布局" className={utilityButtonClassName}>
