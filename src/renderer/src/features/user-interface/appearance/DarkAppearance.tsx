const DarkAppearance = (): React.JSX.Element => {
  return (
    ...
    >
      <rect width="120" height="80" fill="var(--moon-bg-canvas)" />
      <rect x="0" y="0" width="30" height="80" fill="var(--moon-surface-1)" />
      ...
      <rect x="36" y="8" width="78" height="64" rx="4" fill="var(--moon-surface-2)" />
