...
import { agentOperationRecordSchema } from '@shared/domain/chat-validation'

import { defaultChatUserId, type AgentOperationRecord } from '../../shared/domain/chat'
...
function normalizeAgentOperationRecord(operation: AgentOperationRecord) {
  return {
    ...operation,
