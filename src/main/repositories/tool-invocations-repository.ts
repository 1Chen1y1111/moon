...
import { toolInvocationRecordSchema } from '@shared/domain/chat-validation'
...
export class ToolInvocationsRepository {
  ...
  async save(toolInvocation: ToolInvocationRecord): Promise<ToolInvocationRecord> {
    ...
    const operationId =
      parsedToolInvocation.operationId ?? parentMessage.operationId ?? existingRow?.toolMessage.operationId
