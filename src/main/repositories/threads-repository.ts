...
import { threadRecordSchema } from '@shared/domain/chat-validation'

import { defaultChatUserId, type ThreadRecord } from '../../shared/domain/chat'
...
function normalizeThreadRecord(thread: ThreadRecord) {
  return {
    ...thread,
