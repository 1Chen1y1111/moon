...
import { topicRecordSchema } from '@moon/shared/domain/chat-validation'

import { defaultChatUserId, type TopicRecord } from '@moon/shared/domain/chat'
...
export class TopicsRepository {
  ...
  async save(topic: TopicRecord): Promise<TopicRecord> {
    ...
    return topicRecordSchema.parse(topicValues)
  }
}
...
function normalizeTopicRecord(topic: TopicRecord): typeof topics.$inferInsert {
  return {
    ...topic,
