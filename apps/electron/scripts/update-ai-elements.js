...
function updateComponents() {
  ...
  try {
    const command = `cd "${projectRoot}" && pnpm dlx shadcn@latest add --overwrite --path ${aiElementsPath} ${components.join(' ')}`
