...
if (args.has('--help') || args.has('-h')) {
  console.log(`Usage:
  pnpm --filter @moon/electron reset:data      Back up and reset Moon database + attachments
  pnpm --filter @moon/electron reset:data:all  Back up and reset the whole Electron userData directory
